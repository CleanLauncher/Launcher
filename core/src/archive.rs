...
mod tests {
    ...
    fn zip_list_and_read() {
        ...
        let temp_dir = std::env::temp_dir().join("launcher_core_archive_test");
    ...
    fn zip_extract_single_file() {
        ...
        let temp_dir = std::env::temp_dir().join("launcher_core_archive_extract");
        fs::create_dir_all(&temp_dir).unwrap();
        let archive_path = temp_dir.join("test.zip");
        fs::write(&archive_path, &zip_data).unwrap();
    ...
    fn zip_extract_directory() {
        ...
        let temp_dir = std::env::temp_dir().join("launcher_core_archive_extractdir");
        fs::create_dir_all(&temp_dir).unwrap();
        let archive_path = temp_dir.join("test.zip");
        fs::write(&archive_path, &zip_data).unwrap();
    ...
    fn zip_create_and_read_back() {
        let temp_dir = std::env::temp_dir().join("launcher_core_archive_create");
        fs::create_dir_all(&temp_dir).unwrap();
    ...
    #[test]
    fn zip_merge() {
        let temp_dir = std::env::temp_dir().join("launcher_core_archive_merge");
        fs::create_dir_all(&temp_dir).unwrap();
