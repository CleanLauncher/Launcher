...
{
    m_columnNames           = QStringList({"Enable",
                                           "Image",
                                           "Name",
                                           "Version",
                                           "Last Modified",
                                           ...
                                           "Required By",
                                           "File Name"});
    m_columnNamesTranslated = QStringList({tr("Enable"),
                                           tr("Image"),
                                           tr("Name"),
                                           tr("Version"),
                                           tr("Last Modified"),
                                           ...
                                           tr("Required By"),
                                           tr("File Name")});
    m_columnSortKeys        = {SortType::Enabled,
                               SortType::Name,
                               SortType::Name,
                               SortType::Version,
                               SortType::Date,
...
bool ModFolderModel::setResourceEnabled(const QModelIndexList& indexes, EnableAction action)
{
    ...
    if (requiredToEnable.size() > 0 || requiredToDisable.size() > 0) {
        ...
        auto* box = CustomMessageBox::selectable(
            nullptr, title, message, QMessageBox::Warning, QMessageBox::Yes | QMessageBox::No | QMessageBox::Cancel, QMessageBox::No);
