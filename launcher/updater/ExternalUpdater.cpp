...
ExternalUpdater::~ExternalUpdater()
{
...
void ExternalUpdater::checkForUpdates()
{
...
bool ExternalUpdater::getAutomaticallyChecksForUpdates()
{
    return priv->autoCheck;
}

double ExternalUpdater::getUpdateCheckInterval()
{
    return priv->updateInterval;
}

bool ExternalUpdater::getBetaAllowed()
{
    return priv->allowBeta;
}

void ExternalUpdater::setAutomaticallyChecksForUpdates(bool check)
{
...
void ExternalUpdater::setUpdateCheckInterval(double seconds)
{
...
void ExternalUpdater::setBetaAllowed(bool allowed)
{
...
void ExternalUpdater::resetAutoCheckTimer() const
{
...
void ExternalUpdater::connectTimer()
{
    connect(&priv->updateTimer, &QTimer::timeout, this, &ExternalUpdater::autoCheckTimerFired);
}

void ExternalUpdater::disconnectTimer()
{
    disconnect(&priv->updateTimer, &QTimer::timeout, this, &ExternalUpdater::autoCheckTimerFired);
}

void ExternalUpdater::autoCheckTimerFired() const
{
