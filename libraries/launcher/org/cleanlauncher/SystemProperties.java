package org.cleanlauncher;

import org.cleanlauncher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("org.cleanlauncher.instance.name", name);
        if (iconId != null)
            System.setProperty("org.cleanlauncher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.cleanlauncher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.cleanlauncher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("org.cleanlauncher.window.dimensions", windowDimensions);
