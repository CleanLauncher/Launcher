...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (iconId != null)
            System.setProperty("org.launcher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.launcher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.launcher.window.title", windowTitle);
